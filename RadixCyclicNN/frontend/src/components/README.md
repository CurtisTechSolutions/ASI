...
| `ConversePanel.jsx` | Converse | the model talking to itself. Newest turn on top, stutter detection, "Explore" to back out of a repetition, and "Think before backing up" - the 💭 line under a turn is what it thought |
