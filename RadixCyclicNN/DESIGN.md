...
* `PredictPanel.jsx` — prefix, length, mode (dijkstra/sample), to-end, step penalty; shows continuation (prefix + highlighted continuation), cost, path chips with per-step costs.
