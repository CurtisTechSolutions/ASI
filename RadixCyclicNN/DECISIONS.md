...
number · D-079 a setting's home is decided by who keeps it · D-080 a model is taught backwards by its run, and asked
...
### D-080 — A model is taught backwards by its training run, and asked backwards by its caller
