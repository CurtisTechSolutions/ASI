...
**Part XIX — The copy editor** · D-080 a correction is a diff, and the LLM is asked for the smallest one ·
D-081 the veto can keep its provenance to itself
...
### D-080 — A correction is a diff, and the LLM is asked for the smallest one
