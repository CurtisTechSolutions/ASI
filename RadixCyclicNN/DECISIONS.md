...
**Part XIX — Today's format** · D-080 the format is a rendering of the search, and the thinking is its trace
...
# Part XIX — Today's format

### D-080 — Today's format is a rendering of the search, and the thinking is its trace
...
* The thinking's lines are a contract (DESIGN §36.3): a change to one is a change to three ports and two suites.
