...
var query = (params) => {
	const usable = Object.entries(params || {}).filter(([, v]) => v !== void 0 && v !== null && v !== "");
	return usable.length ? `?${new URLSearchParams(usable)}` : "";
};
var get = (name, params) => request(`/api/${name}${query(params)}`);
var post = (name, body) => request(`/api/${name}`, {
	method: "POST",
...
function GoalTree({ tree, chosen }) {
	...
	const render = (goal) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
			className: `goal ${mark.cls}${isChosen ? " chosen" : ""}`,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "goal-mark",
					children: mark.glyph
				...
				goal.id !== "root" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: `goal-badge ${goal.atomic ? "atomic" : "vague"}`,
					children: goal.atomic ? "verifiable" : "needs a check"
				}),
				(byParent.get(goal.id) || []).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: (byParent.get(goal.id) || []).map(render) })
			]
		}, goal.id);
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
		className: "goal-tree",
		children: root ? render(root) : null
	});
}
//#endregion
...
//#endregion
//#region src/viz/Scatter.jsx
function Scatter({ traces, selected, onSelect, size = 560 }) {
	const [hover, setHover] = (0, import_react.useState)(null);
	const pad = 28;
	const place = (v) => pad + (v + 1) / 2 * (size - 56);
	const radius = (t) => 3.2 + Math.min(1, Math.log1p(t.hits) / Math.log(30)) * 5.5;
	const kinds = (0, import_react.useMemo)(() => [...new Set(traces.map((t) => t.kind))].sort(), [traces]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
				...
				children: [
					...
					traces.map((t) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
							...
							fillOpacity: t.grade === null ? .18 : .42 + t.credibility * .5,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [kinds.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "legend-item",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { style: { background: colourOf(k) } }), k]
				}, k)), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "legend-note",
					children: "hollow = ungraded · size = times recalled"
				})]
			}),
			shown && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "pill",
						style: { borderColor: colourOf(shown.kind) },
						children: shown.kind
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "tip-grade",
						children: [shown.grade === null ? "ungraded" : `grade ${shown.grade.toFixed(2)}`, shown.verified && " · verified"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: shown.text.slice(0, 260) })
				]
			})
		]
	});
...
function GradeStages({ grade, compact = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: `stage-row${compact ? " compact" : ""}`,
		children: [grade.stages.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			className: `stage score ${grade.score > 0 ? "pass" : "fail"}`,
			children: [grade.score > 0 ? "+" : "", grade.score.toFixed(2)]
		})]
	});
}
//#endregion
